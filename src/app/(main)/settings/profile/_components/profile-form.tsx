...
import { updateProfileActions } from "../action";
    ...
    <Card>
      <div className="flex items-center gap-6 mb-8">
        <div className="relative">
          ...
          />
          {isEditing && (
            <button className="absolute -bottom-2 -right-2 bg-primary text-white p-2 rounded-xl shadow-lg border-2 border-white dark:border-gray-900 transition-transform active:scale-90 animate-in zoom-in">
